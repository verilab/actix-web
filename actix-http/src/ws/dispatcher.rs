...
#[pin_project::pin_project]
pub struct InnerDispatcher<S, T, U, I>
where
...
impl<S, T, U, I> InnerDispatcher<S, T, U, I>
where
    S: Service<Request = <U as Decoder>::Item, Response = I>,
    S::Error: 'static,
    S::Future: 'static,
    ...
    <U as Encoder<I>>::Error: fmt::Debug,
{
    ...
    /// Get sink
    pub fn get_sink(&self) -> mpsc::Sender<Result<InnerMessage<I>, S::Error>> {
        self.tx.clone()
    }
...
impl<S, T, U, I> Future for InnerDispatcher<S, T, U, I>
where
    S: Service<Request = <U as Decoder>::Item, Response = I>,
    S::Error: 'static,
    S::Future: 'static,
